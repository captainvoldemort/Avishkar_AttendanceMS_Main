...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            STUDENT_ENTRY = tk.Entry(
                MFW, width=20, bg="blue", fg="red", font=("times", 23, " bold ")
            )
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/home/rpiavishkar/Desktop/Avishkar_AttendanceMS_Main/Attendance(Manually)/"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"/home/rpiavishkar/Desktop/Avishkar_AttendanceMS_Main/Attendance(Manually)"'
                )
    ...
    SUB_ENTRY = tk.Entry(
        sb, width=20, bg="blue", fg="red", font=("times", 23, " bold ")
    )
